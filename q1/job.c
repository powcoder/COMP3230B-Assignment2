...
void makeBattery(sem_t *sem_space, sem_t *sem_battery ) {
	//TODO call makeItem and pass in the time for makeing battery. time: TIME_BATTERY
}
...
void makeCar(sem_t *sem_space, int space_limit, sem_t *sem_car,
	...
	//TODO call getItem 7 times to get 7 windows
	//TODO call getItem 4 times to get 4 tires
	//TODO call getItem to get a battery pack
	//TODO call getItem to get a car body
	// assembly car by sleep 
	sleep(TIME_CAR);
